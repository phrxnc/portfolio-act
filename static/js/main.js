function portfolioApp() {
    ...
    skills: [
        ...
        { name: "WordPress", type: "tools", icon: "bx bxl-wordpress", color: "text-blue-500" },
        { name: "Elementor", type: "tools", icon: "fa-brands fa-elementor", color: "text-pink-500" },
        { name: "SEO", type: "tools", icon: "bx bx-line-chart", color: "text-emerald-300" }
    ],
    projects: [
        {
        title: "Vintazk Outsourcing",
        description: "A BPO company website focused on lead generation and client acquisition support.",
        tech: ["WordPress", "Elementor", "SEO"],
        image: "static/images/vintazk.webp",
        url: "https://vintazk.com",
        ctaLabel: "Visit Site",
